...
public class ClientConnection implements Connectable {
	...
	private Socket       	connection;    // connection socket using TCP/IP
	private InputStream  	input;		   // input stream generated from the socket to send and receive	
	private OutputStream 	output;
	
	
	@Override
	public void connect ( String hostAddress , int port ) throws ClientConnectionException {
		...
		try {			
			...
			// handle exception
			throw new ClientConnectionException ( "Error in connecting to server" );
		}
	}
	...
	public void disconnect () throws ClientConnectionException {
		...
		try {
			...
			//handle exception
			throw new ClientConnectionException ( "Error in closing connection" );
		}
	}
